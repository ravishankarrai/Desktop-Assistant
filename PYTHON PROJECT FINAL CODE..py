...
# get property of voices from the Assistent varible in which we initialise the pyttsx3
...
def taskexecution():
    ...
    while True:
        ...
        if "hello" in query:
            ...
            ss.save(f"{name}.png")
            speak(
                "i am done sir ,the screenshot is saved in main folder ,now i am ready for next command")
        elif "code " in query:
            os.startfile(
